...
public class ImaeScoreSheet {

    UtilityFunction utilityFunction = new UtilityFunction();
    DbFunctions dbFunctions = new DbFunctions();

    void addImaObjectInSheet(Document document, String payerCode, CSVPrinter csvPrinter) throws IOException {
                ...
                if(patientAge>11 ) {
                    ...
                    if (payersList.size() != 0) {
                        for (String payerCode:payersList) {
                            ...
                            if (((payerCodeType.equals(Constant.CODE_TYPE_COMMERCIAL) || payerCodeType.equals(Constant.CODE_TYPE_MEDICAID)) && patientAge==13))
                            {
                                addImaObjectInSheet(document,payerCode,csvPrinter);
                            }
                        }
                    }
                    else {
