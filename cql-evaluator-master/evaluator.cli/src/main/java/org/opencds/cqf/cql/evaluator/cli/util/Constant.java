...
public class Constant {
   ...
   public static final String FOLDER_NAME= "/COU_HEDIS_MY2022";
// public static final String testResourceRelativePath = "resources";  //for jar
   ...
   public static final String LIBRARY_NAME = "COU_HEDIS_MY2022";

   public static final String EP_DICTIONARY = "dictionary_ep_2022_code";

   public static final String MAIN_FHIR_COLLECTION_NAME = "ep_encounter_Fhir_COU_Sample_deck";
   public static final String FHIR_UNPROCESSED_COLLECTION_NAME = "COU_Sample_Deck_Fhir_Unprocessed_Patients";
