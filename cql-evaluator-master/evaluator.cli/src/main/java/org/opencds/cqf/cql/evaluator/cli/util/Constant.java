...
// public static final String testResourceRelativePath = "resources";  //for jar
   ...
   public static final String MAIN_FHIR_COLLECTION_NAME = "ep_encounter_fhir_CCS_Sample_Deck";
   public static final String FHIR_UNPROCESSED_COLLECTION_NAME = "CCS_Sample_Deck_Fhir_Unprocessed_Patients";
