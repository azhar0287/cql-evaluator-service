...
public class Constant {
   ...
   public static final String FOLDER_NAME= "/UOP_HEDIS_MY2022";
// public static final String testResourceRelativePath = "resources";  //for jar
   ...
   public static final String LIBRARY_NAME = "UOP_HEDIS_MY2022";

   public static final String EP_DICTIONARY = "dictionary_ep_2022_code";


   public static final String MAIN_FHIR_COLLECTION_NAME = "ep_encounter_fhir_uop_sample_deck";
   public static final String FHIR_UNPROCESSED_COLLECTION_NAME = "Uop_Sample_Deck_Fhir_Unprocessed_Patients";
   public static final String EP_CQL_PROCESSED_DATA="ep_cql_uop_sample_deck_processed_data";
