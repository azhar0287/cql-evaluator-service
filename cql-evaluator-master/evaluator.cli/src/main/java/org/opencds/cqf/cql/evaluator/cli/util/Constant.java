...
public class Constant {
   ...
   public static final String FOLDER_NAME= "/AISE_HEDIS_MY2022";
// public static final String testResourceRelativePath = "resources";  //for jar
   ...
   public static final String LIBRARY_NAME = "AISE_HEDIS_MY2022";

   public static final String EP_DICTIONARY = "dictionary_ep_2022_code";


   public static final String MAIN_FHIR_COLLECTION_NAME = "ep_encounter_fhir_AIS_Test_Deck";
   public static final String FHIR_UNPROCESSED_COLLECTION_NAME = "AISE_Sample_Deck_Fhir_Unprocessed_Patients";
